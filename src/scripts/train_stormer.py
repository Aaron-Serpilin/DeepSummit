...
optimizer = torch.optim.AdamW(stormer.parameters(),lr=0.0001, betas=(0.9, 0.999), weight_decay=1e-1)
...
stormer_results = train(model=stormer,
                ...
                writer=create_writer(experiment_name="stormer_runs",
                                    extra="epochs_50_lr_1e-4_hidden_size_160_depth_12_heads_8_decay_1e-1"))

plot_loss_curves(stormer_results)

save_model(stormer,
          "/var/scratch/ase347/DeepSummit/checkpoints",
          "stormer_epochs_50_lr_1e-4_hidden_size_160_depth_12_heads_8_decay_1e-1.pth")
